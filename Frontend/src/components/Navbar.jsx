...
const Navbar = () => {
 ...
 useEffect(()=>{
  ...
  return (
    <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 dark:bg-slate-800 dark:text-white z-[5] ${sticky?"sticky-navbar shadow-md bg-base-200 duration-300 transition-all ease-in-out" : ""} `}>
